...
import type { PolymorphicComponentPropWithRef } from "flowbite-react/dist/types/helpers/generic-as-prop";
import type { DeepPartial } from "flowbite-react/dist/types/types";
import type { FlowbiteBoolean, FlowbiteColors, FlowbiteGradientColors, FlowbiteGradientDuoToneColors, FlowbiteSizes } from "flowbite-react/dist/types/components/Flowbite";
import type { PositionInButtonGroup } from "flowbite-react/dist/types/components/Button/ButtonGroup";
...
export declare const Button: (<C extends ElementType = "button">(props: ButtonProps<C>) => JSX.Element) & {
    ...
    Group: import("react").FC<import("flowbite-react/dist/types/components/Button/ButtonGroup").ButtonGroupProps>;
};
